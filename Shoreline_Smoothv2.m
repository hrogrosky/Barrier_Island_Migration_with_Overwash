...
function [Hstar,EastSL_change] = Shoreline_Smoothv2(Hstar)
...
EastSL_smooth(row_top:row_bot) = round(medfilt1(EastSL(row_top:row_bot),N,[],'truncate'));
...
% use medfilt1 to smooth the ESL and WSL a 150th order one-dimensional median fit
EastSL_1_smooth(row_top:row_bot) = round(medfilt1(EastSL_1(row_top:row_bot),N,[],'truncate'));
...
% use medfilt1 to smooth the ESL and WSL a 150th order one-dimensional median fit
EastSL_2_smooth(row_top:row_bot) = round(medfilt1(EastSL_2(row_top:row_bot),N,[],'truncate'));
...
% use medfilt1 to smooth the ESL and WSL a 150th order one-dimensional median fit
EastSL_3_smooth(row_top:row_bot) = round(medfilt1(EastSL_3(row_top:row_bot),N,[],'truncate'));
...
% use medfilt1 to smooth the ESL and WSL a 150th order one-dimensional median fit
EastSL_4_smooth(row_top:row_bot) = round(medfilt1(EastSL_4(row_top:row_bot),N,[],'truncate'));
