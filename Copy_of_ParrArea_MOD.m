...
%scale by 1.05, shift 120 columns to the right and down 120
...
Model_Area = [Area_yr0, Area_yr0, Area_yr0]

Area_prct = [(Area_yr0/sum(sum(H_1984)))*100, (Area_yr0/sum(sum(H_1998)))*100, (Area_yr0/sum(sum(H_2011)))*100]
...
xticklabels(x_km);
yticklabels(y_km);
xlabel('Kilometers (km)','FontSize',16);
ylabel('Kilometers (km)','FontSize',16);
text(-100,3600,'(a)','FontSize',16);
title('Year 0 Contours',FontSize=16);
set(gca, 'YDir','reverse')
...
title('Year 14 Contours',FontSize=16);
set(gca, 'YDir','reverse')
...
set(gca,'XTickLabel',{' '})
set(gca,'YTickLabel',{' '})
text(-100,3650,'(c)','FontSize',16);
legend('Model Contour', 'Observed Contour',fontsize=16);
title('Year 27 Contours',FontSize=16);
set(gca, 'YDir','reverse')

title(tlc, 'Persistence Forecast',FontSize=18);
%%
